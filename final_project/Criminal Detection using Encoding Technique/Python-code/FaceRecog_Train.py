...
def faceDetection(test_img):
    ...
    face_haar_cascade=cv2.CascadeClassifier(r'F:\Python\ML\Criminal Detection using Encoding Technique\haarcascade_frontalface_default.xml')#Load haar classifier
