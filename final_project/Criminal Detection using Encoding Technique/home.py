...
def basicPageSetup(pageNo):
    ...
    back_img = tk.PhotoImage(file= r"F:\Python\ML\Criminal Detection using Encoding Technique\img\back.png")
...
logo = tk.PhotoImage(file = r"F:\Python\ML\Criminal Detection using Encoding Technique\img\logo2.png")
